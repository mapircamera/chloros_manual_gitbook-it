...
{% hint style=&quot;success&quot; %}
**Flusso di lavoro ottimale**: utilizzare Sandbox per sperimentare e trovare le impostazioni ottimali per indice e LUT, quindi applicare tali impostazioni durante l&#x27;elaborazione del progetto all&#x27;intero set di dati.
{% endhint %}
...
1. **Aprire un&#x27;immagine** dalla griglia delle immagini principale cliccandoci sopra
...
{% hint style=&quot;success&quot; %}
**Potere di visualizzazione**: l&#x27;applicazione di una LUT a colori a un&#x27;immagine indice in scala di grigi rende notevolmente più facile identificare modelli, anomalie e aree di interesse a colpo d&#x27;occhio.
{% endhint %}
...
* **11-20 classi**: sfumature uniformi, aspetto continuo
* **20+ classi**: quasi continue, massima uniformità
...
### Regolazione delle gamme di valori

I **controlli della gamma di valori** determinano quali valori dell&#x27;indice vengono mappati su quali colori nel gradiente:

**Controlli della gamma nel pannello LUT:**
...
* Pixel **al di sotto del minimo** → visualizzazione utilizzando il **primo colore** della gradazione (ad esempio, rosso)
* Pixel **al di sopra del massimo** → visualizzazione utilizzando l&#x27;**ultimo colore** della gradazione (ad esempio, verde)
* **Caso d&#x27;uso**: Enfatizza gli estremi, mostra l&#x27;intervallo completo dei dati con colori saturi ai limiti
...
* **Caso d&#x27;uso**: evidenziazione sottile, mantenimento del contesto mentre si enfatizzano le aree di interesse
* **Esempio**: evidenziazione a colori della vegetazione stressata (NDVI 0,3-0,5) mentre le aree sane vengono mostrate in grigio

#### 4. Sfondo originale

* I pixel **fuori dal range** visualizzano l&#x27;**immagine multispettrale originale**
* I pixel **all&#x27;interno del range** mostrano una **gradazione di colore**
...
Per avere il pieno controllo della visualizzazione, è possibile creare **gradienti di colore personalizzati** modificando i singoli stop di colore.

**Per creare un gradiente personalizzato:**

1. Nel pannello LUT, individuare la **barra di anteprima del gradiente**.
2. Cercare i **quadrati dei campioni di colore** sotto il gradiente.
3. **Fare clic su uno stop di colore** per selezionarlo.
4. Si aprirà un **selettore di colori**
5. Scegliere un nuovo colore utilizzando:
   * **Ruota dei colori**: selezione visiva dei colori
   * **Cursori RGB/HSV**: controllo preciso dei colori
   * **Inserimento codice esadecimale**: specifica esatta del colore (ad esempio, `#FF0000` per il rosso)
...
* **Rimuovere un&#x27;interruzione**: fare doppio clic sul quadrato di colore per rimuovere il campione
...
**Salvataggio di gradienti personalizzati**: i gradienti personalizzati possono essere salvati e riutilizzati. Fai clic sull&#x27;icona di salvataggio nel pannello LUT per conservare le combinazioni di colori personalizzate per un utilizzo futuro.
{% endhint %}
...
* **Modifica colori** → Il gradiente personalizzato si applica immediatamente
...
3. **Applicare il gradiente LUT** - Iniziare con Red-Giallo-Green preimpostato
...
7. **Perfeziona i colori** - Personalizza la sfumatura se necessario per enfatizzare aspetti specifici
8. **Finalizza le impostazioni** - Documenta le impostazioni e copiale nelle Impostazioni di progetto per l&#x27;elaborazione dell&#x27;esportazione
...
* **Applica all&#x27;elaborazione**: utilizza le impostazioni scoperte in [Impostazioni progetto](../project-settings/project-settings.md)
