...
In Chloros, i **livelli** si riferiscono alle diverse uscite di immagine disponibili per una singola immagine sorgente. Quando si elaborano le immagini, Chloros crea più versioni:
...
* Riflettanza calibrata utilizzando i dati target (se abilitato)
...
* Se lo stesso livello non esiste, l&#x27;impostazione predefinita è JPG
...
4. Continuare la navigazione: tutte le immagini mostrano il livello NDVI
...
1. Aprire l&#x27;immagine elaborata in Image Viewer
...
### Flusso di lavoro 3: Verifica dell&#x27;obiettivo

**Obiettivo**: Verificare che tutte le immagini dell&#x27;obiettivo siano state rilevate correttamente

1. Passare a un&#x27;immagine dell&#x27;obiettivo
2. Selezionare **RAW (Target)** dal menu a tendina
3. Verificare che gli obiettivi di calibrazione siano chiaramente visibili e rilevati
...
Livelli diversi mostrano intervalli di valori pixel diversi:
...
* **Esempi**:
  ...
  * EVI: da 0 a 1 (vegetazione potenziata)

***

## Suggerimenti e best practice

### Passaggio efficiente da un livello all&#x27;altro
...
* **Livelli indice**: velocità simile ai livelli di riflettanza
